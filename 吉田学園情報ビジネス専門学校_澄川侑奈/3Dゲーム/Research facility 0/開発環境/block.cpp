...
#define MAX_SIZE_BLOCK_X	(90.0f)		// サイズ_x
#define MAX_SIZE_BLOCK_Y	(10.0f)		// サイズ_y
#define MAX_SIZE_BLOCK_Z	(10.0f)		// サイズ_z
...
void DrawBlock(void)
{
	...
	if (g_block.bUse == true)
	{
		...
		for (unsigned int nCutMat = 0; nCutMat < g_nNumMat; nCutMat++)
		{
			// マテリアルの設定
