...
HRESULT InitObject(void)
{
	...
	// 柵_X軸20
	SetObject(D3DXVECTOR3(-240.0f, 0.0f, -295.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-140.0f, 0.0f, -295.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(140.0f, 0.0f,  -295.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(240.0f, 0.0f,  -295.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);

	SetObject(D3DXVECTOR3(-240.0f, 0.0f, -95.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-140.0f, 0.0f, -95.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-40.0f, 0.0f,  -95.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(40.0f, 0.0f,   -95.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(140.0f, 0.0f,  -95.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(240.0f, 0.0f,  -95.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	...
	SetObject(D3DXVECTOR3(-40.0f, 0.0f,  295.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(40.0f, 0.0f,   295.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(140.0f, 0.0f,  295.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(240.0f, 0.0f,  295.0f), D3DXVECTOR3(0.0f, 0.0f, 0.0f), D3DXVECTOR3(100.0f, 400.0f, 15.0f), OBJECT_FENCE);
	...
	// 柵_Z軸
	SetObject(D3DXVECTOR3(-290.0f, 0.0f, -240.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-290.0f, 0.0f, -140.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-290.0f, 0.0f, -40.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-290.0f, 0.0f, 40.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-290.0f, 0.0f, 140.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-290.0f, 0.0f, 240.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);

	SetObject(D3DXVECTOR3(-90.0f, 0.0f, -440.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-90.0f, 0.0f, -340.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-90.0f, 0.0f, -240.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-90.0f, 0.0f, -140.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-90.0f, 0.0f, 140.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(-90.0f, 0.0f, 240.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	...
	SetObject(D3DXVECTOR3(290.0f, 0.0f, -440.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(290.0f, 0.0f, -340.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(290.0f, 0.0f, 140.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
	SetObject(D3DXVECTOR3(290.0f, 0.0f, 240.0f), D3DXVECTOR3(0.0f, D3DXToRadian(90.0f), 0.0f), D3DXVECTOR3(15.0f, 400.0f, 100.0f), OBJECT_FENCE);
