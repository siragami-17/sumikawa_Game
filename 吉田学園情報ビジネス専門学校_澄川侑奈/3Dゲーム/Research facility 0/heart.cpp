...
#define MAX_HEART_X				(1100)
#define MAX_HEART_Y				(590)
...
HRESULT InitHeart(void)
{
	...
	// 頂点座標
	pVtx[0].pos = D3DXVECTOR3(g_posHeart.x + MAX_HEART_X    ,g_posHeart.y +  MAX_Y+ MAX_HEART_Y, g_posHeart.z + 0.0f);
	pVtx[1].pos = D3DXVECTOR3(g_posHeart.x + MAX_HEART_X    ,g_posHeart.y + MAX_HEART_Y, g_posHeart.z + 0.0f);
	pVtx[2].pos = D3DXVECTOR3(g_posHeart.x + MAX_X+MAX_HEART_X,g_posHeart.y +  MAX_Y+ MAX_HEART_Y, g_posHeart.z + 0.0f);
	pVtx[3].pos = D3DXVECTOR3(g_posHeart.x + MAX_X+MAX_HEART_X,g_posHeart.y + MAX_HEART_Y, g_posHeart.z + 0.0f);
