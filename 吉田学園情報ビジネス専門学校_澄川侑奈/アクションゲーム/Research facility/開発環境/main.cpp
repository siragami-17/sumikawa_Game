...
#define WINDOW_NAME "Research facility"								//ウインドウ名
...
void Update(void)
{
	UpdateXcontroller();			//コントローラーの更新処理(Xinput)
